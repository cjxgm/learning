...
[
	[	// sqr
		...
		0x00003144, 0x00000000, 0x0000a145, 0x00000000,
		0x00073146, 0x0000a146, 0x00007147, 0x00000000,
		0x00003145, 0x00000000, 0x0000a146, 0x00000000,
		0x00073147, 0x0000a146, 0x00007151, 0x00000000,

		0x00007144, 0x00000000, 0x00000000, 0x00000000,
	...
	[	// tri
		...
		0x0000f552, 0x00004400, 0x00007400, 0x00004400,
		0x0000f550, 0x00004400, 0x00007400, 0x00004400,

		0x00008154, 0x000a6255, 0x000a8356, 0x00006457,
		0x00008555, 0x000a6656, 0x000a8757, 0x00006761,
		0x0000a764, 0x00064654, 0x0000a764, 0x00064854,
		0x0006a764, 0x00064654, 0x0006a764, 0x00064854,

		0x00007764, 0x00000000, 0x00000000, 0x00000000,
		0x00000000, 0x00000000, 0x000af764, 0x000a1764,
		0x00007764, 0x0000a700, 0x00003600, 0x00007500,
		0x00007400, 0x00007300, 0x00007200, 0x00007100
	],
	[	// hi hat
		0x00117777, 0x00010000, 0x00117777, 0x00010000,
		0x00107777, 0x00000000, 0x00107777, 0x00000000,
		0x00000000, 0x00000000, 0x00107777, 0x00000000,
		0x00117777, 0x00107777, 0x00107777, 0x00000000,
	...
	[	// drum
		...
		0x00007944, 0x00007835, 0x00007f55, 0x00007a44,
		0x00017944, 0x00007835, 0x00007f55, 0x00007a44,
		0x00007944, 0x00017835, 0x00117f55, 0x00117f55,

		0x00007f55, 0x00000000, 0x00007944, 0x00007944,
		0x00007944, 0x00000000, 0x00000000, 0x00000000
	]
...
//	last_gain[2] => osc_hat.gain;
	...
	// random panning
	if (!last_samp[0] && ((notes[0][crow]>>20) & 0x0F) == 1)
		Math.random2f(-1, 1) +=> last_pan[0];
	if (!last_samp[1] && ((notes[1][crow]>>20) & 0x0F) == 1)
		Math.random2f(-1, 1) +=> last_pan[1];
	if (!last_samp[2] && ((notes[2][crow]>>20) & 0x0F) == 1)
		Math.random2f(-1, 1) +=> last_pan[2];
	if (!last_samp[3] && ((notes[3][crow]>>20) & 0x0F) == 1)
		Math.random2f(-1, 1) +=> last_pan[3];
